...
def plot_results(ts, x_coords, y_coords, vel, omega, start, end, animation=False, scanner=None, video=False, plot_prediction=False):
    if animation & (scanner is not None):
        plot_dynamic_results(ts, x_coords, y_coords, vel, omega, start, end, scanner, video, plot_prediction)
    else:
        plot_static_results(ts, x_coords, y_coords, vel, omega, start, end)

def plot_static_results(ts, xx, xy, vel, omega, start, end):
...
def plot_dynamic_results(ts, xx, xy, vel, omega, start, end, scanner, make_video, plot_prediction):
    if make_video:
