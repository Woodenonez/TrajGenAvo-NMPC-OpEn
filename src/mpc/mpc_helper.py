...
def cost_inside_ellipse(point:Union[List, cs.SX, cs.DM], ellipse_param:List[Union[cs.SX, cs.DM]], weight:float=1):
    ...
    indicator = cs.sum1(cs.fmax(0.0, indicator)**2 * alpha)
